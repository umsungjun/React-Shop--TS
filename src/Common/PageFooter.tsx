...
export default function PageFooter({ theme }: PageFooterProps) {
  // console.log(theme);
...
const Footer = styled.footer`
  ...
  background-color: ${(props) =>
    props.theme === "light" ? "#f9fafb" : "#191d24"};
`;
...
const LinkBoxLinkF = styled.a`
  ...
  &:hover {
    ::before {
      ...
      font-size: 1rem;
      background-color: ${(props) =>
        props.theme === "light" ? "#3d4451" : "#252628"};
      color: ${(props) => (props.theme === "light" ? "#fff" : "#a6adba")};
    }
  }
`;
const LinkBoxLinkI = styled.a`
  font-size: 2rem;
  &:hover {
    ::before {
      content: "instagram";
