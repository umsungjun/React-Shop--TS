...
export default function MainFashionSection(props: ProductListProps) {
  // console.log(Array.isArray(props.productList));
            ...
            return (
              <LinkContainer to={"/"} key={index} theme={props.theme}>
                ...
                <ProductInfo theme={props.theme}>
                  <ProductInfoDivTop theme={props.theme} />
                  <ProductInfoDivMiddle theme={props.theme} />
                  <ProductInfoDivBottom theme={props.theme} />
                </ProductInfo>
              </LinkContainer>
            );
          })}
